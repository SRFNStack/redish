...
module.exports = {
    /**
     * A createDb is a logical grouping of objects of similarish type.
     *
     * Collections should be as small as possible. For instance, a single user should have
     * their own createDb of widgets instead of a single createDb of widgets that has every users data in it.
     ...
     * @param pathReducer The path reducer to use to createDb the path. Default is json path reduce from jpflat
     ...
     * @param idGenerator A function that receives the object being saved and generates a new id for it. The default is to createDb a bson objectid.
    ...
    createDb( client,
        ...
        if( !client ) throw new Error( 'Client must be set before using a createDb' )
        ...
        return {
            ...
            async save( obj, collectionKey ) {
                ...
                //begin transaction to ensure the createDb zset stays consistent
            ...
            /**
             * Find one object in the createDb by it's id
             *
             * @param id
             */
            ...
            // /**
            //  * Find all of the objects stored in this createDb, one page at a time
            ...
            // },
            // /**
            //  * Scan the createDb for a object that has the specified value for the field
            ...
            //     //for each document in each page of the createDb, scan the documents and search for matches
            // }
        }
    }
}